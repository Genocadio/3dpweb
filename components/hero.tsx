        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="space-y-6 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
              <Button size="lg" className="rounded-full text-base md:text-lg group" asChild>
                <a href="https://3dp-admin-portal.vercel.app/">
                  Data Maturity Assessment
                  <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </a>
              </Button>
              <Button size="lg" variant="outline" className="rounded-full text-base md:text-lg border-white/60 text-white hover:bg-white/15 hover:text-white" asChild>
                <a href="#services">
                  View Services
                </a>
              </Button>
